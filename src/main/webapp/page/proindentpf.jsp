	...
	$(function(){
        ...
        $.post(url,null,function(mes){
        	...
        	for(i=0;i<mes.length;i++){
        		...
        		$("#tbody").append("<tr><td>"+mes[i].KIN_NAME+"</td><td>"+mes[i].BUR_G+"</td><td>"+mes[i].RAW_NAME+"</td><td>"+mes[i].RAW_CONTENT+"   "+mes[i].RAW_UNIT+"</td><td>"+yi.toFixed(0)+"</td><td style='display:none'>"+mes[i].RAW_ID+"</td>");
    		} 
