...
public class ErpResuitServiceImpl implements ErpResuitService{
	...
	@Override
	public int findDimResConut(Map<String, Object> map) {
		return mapper.findDimResConut(map);
	}

	@Override
	public List<ErpResuit> findDimKinskRes(String kinId) {
		return mapper.findDimKinskRes(kinId);
	}
