...
public class ErpPurchaseServiceImpl implements ErpPurchaseService{
	...
	public int auditPurchase(Map<String, Object> map) {
		...
		if(state.equals("3")){//当审核通过时将该条采购订单加入资金申请表
			...
			applyasset.setAppassApply(staff.getStaName());//设置人员id
			...
			applyasset.setAppassTime(Tools.getCurDateTime());//设置申请时间
	...
	@Override
	public List<ErpPurchase> selectAlls(Map<String, Object> map) {
		return erpPurchaseMapper.selectAlls(map);
	}

	@Override
	public List<Map<String, Object>> selectKindsById(String purcId) {
		return erpPurchaseMapper.selectKindsById(purcId);
	}

	@Override
	public int purchaseFindRow(Map<String, Object> map) {
		return erpPurchaseMapper.purchaseFindRow(map);
	}
	...
	@Override
	public ErpPurchase showErp(String purcId) {
		return erpPurchaseMapper.showErp(purcId);
	}

	@Override
	public ErpPurchase showKind(String purcId) {
		return erpPurchaseMapper.showKind(purcId);
	}
}
