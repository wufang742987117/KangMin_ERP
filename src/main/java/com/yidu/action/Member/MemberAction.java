...
public class MemberAction {
	...
	public Map<String,Object> showList(int page ,int limit,ErpMember member){
		...
		pagmap.put("memberPhone", member.getMemberPhone());//手机
		pagmap.put("memberSex", member.getMemberSex());//性别
		
		List<ErpMember> list =memberService.selectByPrimaryKey(pagmap);//查询会员
